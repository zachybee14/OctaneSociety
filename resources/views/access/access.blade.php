	...
	<body>
		...
		<div class="main-wrapper">
			<div class="logo-container">
				...
				<div class="buttons-container" :class="invisibleIf(v_state)">
					<button @click="showEnterOverlay">Enter</button>
					<button @click="loginWithFacebook"><i class="fa fa-facebook-official"></i> Facebook</button>
				</div>
			</div>
		</div>

		<div v-if="v_state != null" id="access-overlay" class="overlay">
			...
			<div v-if="v_state == 'collect-car-info'" class="car-wrap">
				...
				<div>
					<select v-model="car.make" v-disabled="car.v_makes == null" @change="loadCarModels">
						...
						<template v-else>
							<option disabled selected :vale="null">Select a make</option>
